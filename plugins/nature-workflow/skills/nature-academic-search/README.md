...
`nature-academic-search` 是面向 Claude Code / Codex 工作流的学术检索技能包，集成 CrossRef、PubMed、arXiv、OpenAlex、Scopus、ScienceDirect 检索源，以及 Unpaywall 开放获取全文。
...
| 工具 | 说明 |
|------|------|
| `search_papers` | 默认四源（CrossRef、PubMed、arXiv、OpenAlex）并发搜索；可显式添加 Scopus / ScienceDirect |
