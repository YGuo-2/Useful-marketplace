...
description: Use for Spce workflow Feature / Requirements-First work when the user starts from product goals, user value, new capabilities, complex feature work, scaffolding, or cross-module refactors without a fixed technical design. Generates product.md, architecture.md, and tasks.md before implementation.
---

# Spce workflow Requirements-First
