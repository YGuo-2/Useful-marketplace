...
- `fixtures/reviewer_verdicts.json`: versioned, externally supplied verdicts from the two independent contract reviewers. The harness validates coverage and carries each verdict, rationale, evidence reference, and artifact SHA-256 into the output.
