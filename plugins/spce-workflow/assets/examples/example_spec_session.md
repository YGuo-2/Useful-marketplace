...
本文档展示一个从 intake 到最终 acceptance 的端到端 Spce workflow 工作流。
...
```bash
python plugins/spce-workflow/scripts/spec_progress.py complete docs/specs/ T-001 --evidence "pytest tests/test_comments_migration.py passed"
```
